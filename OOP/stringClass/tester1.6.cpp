...
const char * MyString::NextToken(int& len)
{
    ...
    //cout << "token index at end of loop: " << token_index << endl;
	//buff[length] = '\0';
	//const char * ret = buff;
	len = length;
...
int main()
{
	...
	*/
    ...
    cout << "asshole!! " << endl;
 	MyString sub2("bbaa");
    MyString sub3("holdthe");
 	MyString sub4("he old");
 	MyString sub5("project");
 	MyString sub6("project");
    ...
    cout << endl << "\nTesting Largest substring between sub1 and sub2\n";
    const char* hld = sub1.LargestCommonSubstring(sub2, len1);
    cout << "Largest Common Substrin Is: ";
    PrintToken(hld, len1);
    
    cout << endl << "\nTesting Largest substring between sub3 and sub4\n";
    const char* hld2 = sub3.LargestCommonSubstring(sub4, len1);
    cout << "Largest Common Substrin Is: ";
    PrintToken(hld2, len1);
    
    cout << endl << "\nTesting Largest substring between sub5 and sub6\n";
    const char* hld3 = sub5.LargestCommonSubstring(sub6, len1);
    cout << "Largest Common Substrin Is: ";
